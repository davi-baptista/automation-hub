...
def ferramentas_sql(token_autenticacao, filepath, mes):
...
def main():
    filepath = r'C:\Users\davi.inov\Desktop\Projetos\Departamento_AEC\02_bater_grupos\data\BASE ATHENAS.xlsx'
    mes = '202401202401'
    
    token = usuarios_auth()
    return_filepath, status = ferramentas_sql(token, filepath, mes)
