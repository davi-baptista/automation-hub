...
def check_excel_existence(account_plan):
    ...
    """
    folder_path = r"X:\INOV - RPA's\Departamento-Contabil\Script - ValidadorDeEstoque\data"
...
def check_account_plan(cnpj, url, headers):
    ...
    if response_sql.status_code // 100 == 2:
        ...
        return None, None, response_sql.status_code
...
if __name__ == "__main__":
    api_main('16722416000153', '01/01/2023', '12/31/2023')